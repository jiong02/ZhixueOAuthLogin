...
$githubOAuth = new \Zhixue\OAuthLogin\Github\OAuth2($GLOBALS['oauth_github']['appid'], $GLOBALS['oauth_github']['appkey'], $GLOBALS['oauth_github']['callbackUrl']);
// 解决只能设置一个回调域名的问题，下面地址需要改成你项目中的地址，可以参考./loginAgent.php写法
// $githubOAuth->loginAgentUrl = 'http://test.com/test/Github/loginAgent.php';
var_dump(
	'access_token:', $githubOAuth->getAccessToken($_SESSION['Zhixue_GITHUB_STATE']),
