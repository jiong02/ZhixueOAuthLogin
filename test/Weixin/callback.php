...
$wxOAuth = new \Zhixue\OAuthLogin\Weixin\OAuth2($GLOBALS['oauth_weixin']['appid'], $GLOBALS['oauth_weixin']['appkey']);
...
$wxOAuth->openidMode = Zhixue\OAuthLogin\Weixin\OpenidMode::OPEN_ID;
*/
var_dump(
	'access_token:', $wxOAuth->getAccessToken($_SESSION['Zhixue_WEIXIN_STATE']),
