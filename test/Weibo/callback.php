...
$weiboOAuth = new \Zhixue\OAuthLogin\Weibo\OAuth2($GLOBALS['oauth_weibo']['appid'], $GLOBALS['oauth_weibo']['appkey'], $GLOBALS['oauth_weibo']['callbackUrl']);
// 解决只能设置一个回调域名的问题，下面地址需要改成你项目中的地址，可以参考./loginAgent.php写法
// $weiboOAuth->loginAgentUrl = 'http://test.com/test/Weibo/loginAgent.php';
var_dump(
	'access_token:', $weiboOAuth->getAccessToken($_SESSION['Zhixue_WEIBO_STATE']),
