...
ZhixueHttp::setDefaultHandler('Zhixue\Util\ZhixueHttp\Handler\Swoole');
...
{
	$qqOAuth = new \Zhixue\OAuthLogin\QQ\OAuth2($GLOBALS['oauth_qq']['appid'], $GLOBALS['oauth_qq']['appkey'], $GLOBALS['oauth_qq']['callbackUrl']);
