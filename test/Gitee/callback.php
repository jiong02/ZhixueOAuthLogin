...
$giteeOAuth = new \Zhixue\OAuthLogin\Gitee\OAuth2($GLOBALS['oauth_gitee']['appid'], $GLOBALS['oauth_gitee']['appkey'], $GLOBALS['oauth_gitee']['callbackUrl']);
// 解决只能设置一个回调域名的问题，下面地址需要改成你项目中的地址，可以参考./loginAgent.php写法
// $giteeOAuth->loginAgentUrl = 'http://test.com/test/Gitee/loginAgent.php';
var_dump(
	'access_token:', $giteeOAuth->getAccessToken($_SESSION['Zhixue_GITEE_STATE']),
